...
class WebApplication extends AbstractKernel implements ApplicationInterface {
	...
	protected function __construct() {
		...
		static::getRegistry()->addImplementation(HandlerInterface::class, new Handler(static::getRegistry()->getImplementation(MainRequestInterface::class), static::getRegistry()->getImplementation(MainResponseInterface::class)));
	}
